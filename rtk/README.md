...
echo ${E_P001} ${N_P001} ${E_P005} ${N_P005} | awk '{pi=4.0*atan2(1,1); r2d=180.0/pi; r2s=3600.0*r2d; E1=$1; N1=$2; E2=$3; N2=$4; e1=E1-500000.0; e2=E2-500000.0; N2mN1=N2-N1; te1pe2=2.0*e1+e2; r0=6362730.7407; cmp=1.0-(( (te1pe2/r0)*(te1pe2/r0) )/27.0)  ;delta_12=-N2mN1*te1pe2*(1.0/(6.0*r0*r0))*cmp; printf("%14.9f\n", r2s*delta_12)}'
  -0.733309260"
```

P005-P001
```
echo "197260.949424616 7563554.648284928 197672.267040272 7564507.074813491" | awk '{pi=4.0*atan2(1,1); r2d=180.0/pi; r2s=3600.0*r2d; E1=$1; N1=$2; E2=$3; N2=$4; e1=E1-500000.0; e2=E2-500000.0; N2mN1=N2-N1; te1pe2=2.0*e1+e2; r0=6362730.7407; cmp=1.0-(( (te1pe2/r0)*(te1pe2/r0) )/27.0)  ;delta_12=-N2mN1*te1pe2*(1.0/(6.0*r0*r0))*cmp; printf("%14.9f\n", r2s*delta_12)}'
   0.733641164
```
