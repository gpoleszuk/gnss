...
;
    ...
    dtsv = eph->af0 + eph->af1 * (t - toc) + eph->af2 * (t - toc) * (t - toc) + dtrel - eph->tgd;
    ...
    */
    ...
    printf("PG%02d %04d %02d %02d %02d %02d %11.8f %11.8f %14.3f %14.3f %14.3f %16.12f | %14.6f %14.6f %14.6f | %14.9f %14.9f %14.9f\n", \
            eph->prn, eph->toc_year, eph->toc_month, eph->toc_day, eph->toc_hour, eph->toc_minute, eph->toc_second, \
            t, X, Y, Z, dtsv, Xdot, Ydot, Zdot, Xddot, Yddot, Zddot);
    return 0;
  } else {
